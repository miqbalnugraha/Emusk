...
class SaranaBelumController extends Controller
{
  ...
  public function index(Request $request){
    $data=[
      ...
      'kinerja'=>$this->SaranaDiuji->kinerja(),
      'pending'=> $this->SaranaDiuji->pending(),
      'belum'=> $this->SaranaDiuji->belumDiuji(),
    ...
    return view('monitoring.belum.index')->with($data);
  }
  public function belum(Request $request){
    ...
    return view('monitoring.belum.belum')->with($data);
  }
  public function pending(Request $request){
    ...
    return view('monitoring.belum.pending')->with($data);
  }
}
