...
@section('subTitle','Sarana Sudah Diuji')
...
@section('content')
  ...
  <section class="content">
    <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="small-box bg-success">
                  <div class="inner">
                    <strong><span style="font-size: 40px;">{{ $lulus }} </span></strong> <span style="font-size: 15px;"> / {{ $penugasan }} (penugasan)</span>
                    <span><br>Lulus<br></span>
                    <strong><span style="text-align:center;font-size: 30px">@if($penugasan!=0){{ number_format($lulus/$penugasan*100,1) }} % @else 0 @endif </span></strong>
                  </div>
                  <div class="icon">
                    <i class="fas fa-check"></i>
                  </div>
                  <a href="/SaranaSudahDiuji/lulus" class="small-box-footer">
              ...
              <div class="col-lg-6">
                ...
                <div class="small-box bg-danger">
                  <div class="inner">
                    <strong><span style="font-size: 40px;">{{ $tidakLulus }} </span></strong> <span style="font-size: 15px;"> / {{ $penugasan }} (penugasan)</span>
                    <span><br>Tidak Lulus<br></span>
                    <strong><span style="font-size: 30px;">@if($penugasan!=0){{ number_format($tidakLulus/$penugasan*100,1) }} % @else 0 @endif </span></strong>
                  </div>
                  <div class="icon">
                    <i class="fas fa-times"></i>
                  </div>
                  <a href="/SaranaSudahDiuji/tidak-lulus" class="small-box-footer">
                    More info <i class="fas fa-arrow-circle-right"></i>
                  </a>
                </div>
              </div>
      ...
      <!-- /.col -->
      <div class="card-header text-center bg-olive text-white">
        <div class="d-flex align-items-center">
             <h3 class="mx-auto w-100">Data Sarana Sudah Diuji</h3>
